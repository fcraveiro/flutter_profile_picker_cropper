...
class PickerCropper extends StatefulWidget {
  const PickerCropper({Key? key}) : super(key: key);

  @override
  _PickerCropperState createState() => _PickerCropperState();
}
...
class _PickerCropperState extends State<PickerCropper> {
